<div class="bg-white overflow-hidden shadow-sm sm:rounded-lg m-2 h-[calc(100vh-64px)]"> <!-- CONTENEDOR MAESTRO -->
	...
	<div class="flex items-center w-full my-3">
		<h2 class="text-xl font-semibold my-2 ml-6 text-gray-900 ms- w-full">Panel de control: Reportes</h2>
	...
	<div class="container mx-auto p-8 py-4">
		...
		<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
			...
			<div class="flex justify-center hover:cursor-pointer">
				<a wire:click="reportSalesPDF" class="bg-gray-900 text-white w-full p-6 rounded-lg shadow-lg flex items-center justify-start space-x-4 hover:bg-red-900">
			...
			<div class="flex justify-center hover:cursor-pointer">
				<a wire:click="reportCustomersPDF" class="bg-gray-900 text-white w-full p-6 rounded-lg shadow-lg flex items-center justify-start space-x-4 hover:bg-red-900">
			...
			<div class="flex justify-center hover:cursor-pointer">
				<a wire:click="reportUsersPDF" class="bg-gray-900 text-white w-full p-6 rounded-lg shadow-lg flex items-center justify-start space-x-4 hover:bg-red-900">
					<svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
			...
			<div class="flex justify-center hover:cursor-pointer">
				<a wire:click="reportPaymentsPDF" class="bg-gray-900 text-white w-full p-6 rounded-lg shadow-lg flex items-center justify-start space-x-4 hover:bg-red-900">
					<svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
			...
			<div class="flex justify-center hover:cursor-pointer">
				<a wire:click="reportStockPDF" class="bg-gray-900 text-white w-full p-6 rounded-lg shadow-lg flex items-center justify-start space-x-4 hover:bg-red-900">
					<svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
	...
	<div class="container mx-auto p-8 pt-0">
		...
		<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
			...
			<!-- Botón 1: Reporte de Ventas -->
			<div class="flex justify-center hover:cursor-pointer">
				<a wire:click="reportSalesEXCEL" class="bg-gray-900 text-white w-full p-6 rounded-lg shadow-lg flex items-center justify-start space-x-4 hover:bg-green-900">
					<svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
						<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 15v4m6-6v6m6-4v4m6-6v6M3 11l6-5 6 5 5.5-5.5"/>
					  </svg>
			...
			<!-- Botón 3: Reporte de Clientes -->
			<div class="flex justify-center hover:cursor-pointer">
				<a wire:click="reportCustomersEXCEL" class="bg-gray-900 text-white w-full p-6 rounded-lg shadow-lg flex items-center justify-start space-x-4 hover:bg-green-900">
					<svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
						<path fill-rule="evenodd" d="M4 4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2H4Zm10 5a1 1 0 0 1 1-1h3a1 1 0 1 1 0 2h-3a1 1 0 0 1-1-1Zm0 3a1 1 0 0 1 1-1h3a1 1 0 1 1 0 2h-3a1 1 0 0 1-1-1Zm0 3a1 1 0 0 1 1-1h3a1 1 0 1 1 0 2h-3a1 1 0 0 1-1-1Zm-8-5a3 3 0 1 1 6 0 3 3 0 0 1-6 0Zm1.942 4a3 3 0 0 0-2.847 2.051l-.044.133-.004.012c-.042.126-.055.167-.042.195.006.013.02.023.038.039.032.025.08.064.146.155A1 1 0 0 0 6 17h6a1 1 0 0 0 .811-.415.713.713 0 0 1 .146-.155c.019-.016.031-.026.038-.04.014-.027 0-.068-.042-.194l-.004-.012-.044-.133A3 3 0 0 0 10.059 14H7.942Z" clip-rule="evenodd"/>
					  </svg>
			...
			<!-- Botón 4: Reporte de Usuarios -->
			<div class="flex justify-center hover:cursor-pointer">
				<a wire:click="reportUsersEXCEL" class="bg-gray-900 text-white w-full p-6 rounded-lg shadow-lg flex items-center justify-start space-x-4 hover:bg-green-900">
					<svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
						<path fill-rule="evenodd" d="M12 4a4 4 0 1 0 0 8 4 4 0 0 0 0-8Zm-2 9a4 4 0 0 0-4 4v1a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2v-1a4 4 0 0 0-4-4h-4Z" clip-rule="evenodd"/>
					  </svg>
			...
			<!-- Botón 5: Reporte de Pagos -->
			<div class="flex justify-center hover:cursor-pointer">
				<a wire:click="reportPaymentsEXCEL" class="bg-gray-900 text-white w-full p-6 rounded-lg shadow-lg flex items-center justify-start space-x-4 hover:bg-green-900">
					<svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
						<path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M8 7V6a1 1 0 0 1 1-1h11a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1h-1M3 18v-7a1 1 0 0 1 1-1h11a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1Zm8-3.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Z"/>
					  </svg>
			...
			<!-- Botón 6: Reporte de Stock -->
			<div class="flex justify-center hover:cursor-pointer">
				<a wire:click="reportStockEXCEL" class="bg-gray-900 text-white w-full p-6 rounded-lg shadow-lg flex items-center justify-start space-x-4 hover:bg-green-900">
					<svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
						<path fill-rule="evenodd" d="M5.005 10.19a1 1 0 0 1 1 1v.233l5.998 3.464L18 11.423v-.232a1 1 0 1 1 2 0V12a1 1 0 0 1-.5.866l-6.997 4.042a1 1 0 0 1-1 0l-6.998-4.042a1 1 0 0 1-.5-.866v-.81a1 1 0 0 1 1-1ZM5 15.15a1 1 0 0 1 1 1v.232l5.997 3.464 5.998-3.464v-.232a1 1 0 1 1 2 0v.81a1 1 0 0 1-.5.865l-6.998 4.042a1 1 0 0 1-1 0L4.5 17.824a1 1 0 0 1-.5-.866v-.81a1 1 0 0 1 1-1Z" clip-rule="evenodd"/>
						<path d="M12.503 2.134a1 1 0 0 0-1 0L4.501 6.17A1 1 0 0 0 4.5 7.902l7.002 4.047a1 1 0 0 0 1 0l6.998-4.04a1 1 0 0 0 0-1.732l-6.997-4.042Z"/>
					  </svg>
	...
	<form wire:submit="reportProductsEXCEL">
	...
	<form wire:submit="reportProductsPDF">
